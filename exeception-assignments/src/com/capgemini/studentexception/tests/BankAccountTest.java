...
import com.capgemini.studentexception.main.BankAccount;
...
public class BankAccountTest {
	...
	@Test
	public void testWithdrawWithSufficientFund() throws LowBalanceException, DebitLimitException {
		account.withdraw(5000);
		assertEquals(19000, account.getAccountBalance(),0.01);
	}
	
	@Test(expected = LowBalanceException.class)
	public void testWithdrawWithInSufficientFund() throws LowBalanceException, DebitLimitException {
